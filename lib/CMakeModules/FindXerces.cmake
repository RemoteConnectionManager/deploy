...
ELSE(XERCESC_FOUND)
  SET(XERCES_MISSING_MESSAGE
    "Xerces-c was not found. Make sure XERCES_LIBRARY_DIR and
    XERCES_INCLUDE_DIR are set to the directory of your xerces lib and
    include files. ")

  IF(Xerces_FIND_REQUIRED)
	MESSAGE(FATAL_ERROR "${XERCES_MISSING_MESSAGE}")
  ELSE(Xerces_FIND_REQUIRED)
	MESSAGE(STATUS "${XERCES_MISSING_MESSAGE}")
