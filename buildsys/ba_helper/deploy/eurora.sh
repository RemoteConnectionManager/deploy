...
python ba_helper/ba_helper.py --build_template=gnu_eurora -a Packages/qt/5.3.2/shared_opengl.cfg
python ba_helper/ba_helper.py --build_template=gnu_eurora -a Packages/qtcreator/3.2.1/
