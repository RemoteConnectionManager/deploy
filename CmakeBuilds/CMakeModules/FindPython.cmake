...
ENDIF(WIN32)
	message("dentro di Find Python PYTHON_EXECUTABLE -->${PYTHON_EXECUTABLE}")
...
EXECUTE_PROCESS(COMMAND "${PYTHON_EXECUTABLE}"
  ...
  OUTPUT_VARIABLE PYTHON_INCLUDE_DIR
	...
	message("dentro di Find Python PYTHON_INCLUDE_DIR -->${PYTHON_INCLUDE_DIR}")
	message("dentro di Find Python _PYTHON_LIBRARY_PATH -->${_PYTHON_LIBRARY_PATH}")
