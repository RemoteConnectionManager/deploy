...
autopackage_config_args="-DTurboVNC_build_server:bool=ON -DUSE_SYSTEM_LIBRARIES:bool=ON -Dlibjpeg-turbo_shared:bool=OFF"
ba_module_version="1.0.90_static"
autopackage_version="1.0.90"
