...
ba_module_version="1.0.2"
#autopackage_version=3.10.1
module_build_setup="module load autoload nasm"

ba_home_url="http://www.virtualgl.org/"
ba_download_url="http://sourceforge.net/projects/virtualgl/files/TurboVNC/1.0.2/turbovnc-1.0.2.tar.gz/download"
